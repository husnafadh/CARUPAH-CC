...
words = pickle.load(open('./ml_models/data_words.pkl', 'rb'))
classes = pickle.load(open('./ml_models/data_classes.pkl', 'rb'))
...
def chat(user_message: UserMessage):
    ...
    intent_class = predict_class(message)
    response = generate_response(intent_class)
